...
def get_product(product_urls, location_data):
    ...
    for product_url in product_urls:
        ...
        with gzip.open(f'pagesaves/pagesaves {datetime.now().strftime("%Y-%m-%d")}/pdp/{pid}_{location_data["pincode"]}.html.gz', 'wt', encoding='utf-8') as file:
        ...
        if response.status_code == 200:
            ...
            # with gzip.open(f'pagesaves/pagesaves {datetime.now().strftime("%Y-%m-%d")}/parsed/{pid}_{location_data["pincode"]}.html.gz', 'wt', encoding='utf-8') as file:
