...
cookies = {
    ...
    'K-ACTION': 'null',
    'rt': 'null',
    'at': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IjFkOTYzYzUwLTM0YjctNDA1OC1iMTNmLWY2NDhiODFjYTBkYSJ9..z9KgTJ4GsgIN7HjAq6rAFm4LF-y0S73CGA7gukAA9AQ',
...
def get_product(product_urls, location_data):
    ...
    for product_url in product_urls:
        ...
        json_data['pageUri'] = product_url
        json_data['locationContext']['pincode'] = int(location_data['pincode'])
        ...
        if response.status_code == 200:
            ...
            with gzip.open(f'pagesaves/pdp/{pid}_{location_data["pincode"]}.html.gz', 'wb') as file:
            ...
            with gzip.open(f'pagesaves/parsed/{pid}_{location_data["pincode"]}.html.gz', 'wb') as file:
                    file.write(json.dumps(cleaned_data).encode())
